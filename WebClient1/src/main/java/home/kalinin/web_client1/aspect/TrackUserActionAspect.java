package home.kalinin.web_client1.aspect;
...
public class TrackUserActionAspect {
    @Around("@annotation(home.kalinin.web_client1.aspect.TrackUserAction)")
    ...
    @Before("execution(String home.kalinin.web_client1.controller.HomeController.getHome(org.springframework.ui.Model))")
